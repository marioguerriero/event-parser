/* helper.c generated by valac 0.26.2, the Vala compiler
	...
	_tmp8__length1 = test_events_length1;
	{
		...
		for (entry_it = 0; entry_it < _tmp8__length1; entry_it = entry_it + 1) {
			...
			entry = _tmp9_;
			{
				...
				_tmp13_ = parser_parse_source (_tmp10_, _tmp12_);
				cmp_event = _tmp13_;
				_tmp14_ = cmp_event;
				_tmp15_ = entry;
	...
	_tmp2__length1 = test_events_length1;
	{
		...
		for (entry_it = 0; entry_it < _tmp2__length1; entry_it = entry_it + 1) {
			...
			entry = _tmp3_;
			{
				...
				_tmp7_ = parser_parse_source (_tmp4_, _tmp6_);
				cmp_event = _tmp7_;
				_tmp8_ = cmp_event;
				_tmp9_ = entry;
