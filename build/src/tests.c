/* tests.c generated by valac 0.26.2, the Vala compiler
...
void _vala_main (void) {
	...
	simulated_dt = _tmp0_;
	_tmp2_ = test_en (&_tmp1_);
	test_events = _tmp2_;
	test_events_length1 = _tmp1_;
	_test_events_size_ = test_events_length1;
	print_all_working_test_events (test_events, test_events_length1, simulated_dt);
	print_all_not_working_test_events (test_events, test_events_length1, simulated_dt);
